...
<template>
  <div class="mb-5 ">
    <div class="text-center pb-5">
        <h1>
            <span style="font-size: 60px; font-weight: 700;" class="text-light">Contact</span>
            <span style="font-size: 60px; font-weight: 700;"  class="text-warning ms-3">Us</span>
        </h1>
        <p style="font-weight: 600;" class="text-light">
            Anda memiliki pertanyaan? Sebuah komplikasi? 
            Atau <br> membutuhkan beberapa bantuan tentang produk Visora. 
            Hubungi kami secara bebas
        </p>
    </div>
    <div class="py-2">
